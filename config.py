...
__C.PRE_GCC_MODEL = '/content/C-3-Framework/pre/11-ResSFCN-101_all_ep_94_mae_26.8_mse_66.1.pth' # path to model
...
__C.EXP_PATH = '/content/models' # the path of logs, checkpoints, and current codes
